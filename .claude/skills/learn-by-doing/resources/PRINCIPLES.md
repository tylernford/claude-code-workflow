...
This document provides the scientific rationale for the techniques in SKILL.md. Consult it
when adapting techniques or making judgment calls about learning approaches.
...
The techniques in SKILL.md are designed to counteract these specific risks by
reintroducing:
