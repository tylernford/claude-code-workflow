...
**Why:** Multiple documents created on the same date currently sort alphabetically by
feature name rather than chronologically by creation time.
...
**Decision:** `HHMM` - Compact format that maintains consistent hyphen-separated pattern
without adding extra separators.
...
**Summary:** Updated filename format patterns in `.claude/commands/design.md` and
`.claude/commands/plan.md` to include HHMM time between the date and feature name. All 4
occurrences updated as planned.
